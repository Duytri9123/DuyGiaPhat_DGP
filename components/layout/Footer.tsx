...
export default function Footer() {
  return (
    <footer className="bg-slate-950 dark:bg-black text-slate-100 transition-colors duration-300">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 dark:text-slate-500 leading-relaxed mb-6">
              Chuyên cung cấp vật tư, thiết bị điện công nghiệp và giải pháp
              tự động hóa hàng đầu Việt Nam. Chất lượng không thương hiệu.
            </p>
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-slate-800 dark:bg-slate-700 hover:bg-amber-500 flex items-center justify-center transition"
              >
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-slate-800 dark:bg-slate-700 hover:bg-amber-500 flex items-center justify-center transition text-slate-300"
              >
                <ZaloIcon />
              </a>
              <a
                href="mailto:info@duygiaphat.com.vn"
                className="w-10 h-10 rounded-full bg-slate-800 dark:bg-slate-700 hover:bg-amber-500 flex items-center justify-center transition"
              >
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-slate-400 dark:text-slate-500">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-white font-semibold">
                    Khu Công Nghiệp Tân Bình, P. Tây Thạnh, Q. Tân Phú, TP. Hồ
                    Chí Minh
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  <p className="text-slate-400 dark:text-slate-500">info@duygiaphat.com.vn</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="rounded-lg overflow-hidden h-40 bg-slate-800 dark:bg-slate-700">
              <iframe
      ...
      {/* Bottom Footer */}
      <div className="border-t border-slate-800 dark:border-slate-900 bg-slate-900/50 dark:bg-slate-950/50 py-6 transition-colors">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500 dark:text-slate-600">
          <p>
            © 2024 CÔNG TY TNHH KỸ THUẬT DUY GIA PHÁT. TẤT CẢ QUYỀN LỢI ĐƯỢC
            BẢO LƯU.
          </p>
